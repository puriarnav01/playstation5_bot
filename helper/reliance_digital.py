...
def reach_reliance_digital(client, product, pin, email, password, BANK,
                           CARD_NUMBER, NAME_ON_CARD, MONTH, YEAR, CVV, phone):
    ...
    try:
        ...
        browser.find_element_by_xpath(
            "//div[@class='sc-chPdSV eWorQt']//div[@class='sc-chPdSV gTZViT']//div[@class='sc-chPdSV cfMmfZ']//div[@class='sc-chPdSV iesTLv']//button[@class='ripple sc-bwzfXH ePDJxz sc-jzJRlG dDDLqU']").click()
        time.sleep(20)
    except Exception as e:
        print("login failed")
        browser.close()
